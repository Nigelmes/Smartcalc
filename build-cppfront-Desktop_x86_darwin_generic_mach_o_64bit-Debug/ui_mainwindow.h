...
"}"));
        ...
        push_AC->setGeometry(QRect(0, 200, 60, 60));
...
"}"));
        ...
        push_leftscob->setGeometry(QRect(60, 200, 60, 60));
...
"}"));
        ...
        push_rightscob->setGeometry(QRect(120, 200, 60, 60));
...
"}"));
        ...
        push_mult->setGeometry(QRect(180, 255, 60, 60));
...
"}"));
        ...
        push_mod->setGeometry(QRect(240, 305, 60, 60));
...
"}"));
        ...
        push_atan->setGeometry(QRect(0, 150, 60, 40));
        push_sqrt = new QPushButton(centralwidget);
        push_sqrt->setObjectName(QString::fromUtf8("push_sqrt"));
        push_sqrt->setGeometry(QRect(180, 150, 60, 40));
        push_log10 = new QPushButton(centralwidget);
        push_log10->setObjectName(QString::fromUtf8("push_log10"));
        push_log10->setGeometry(QRect(60, 150, 60, 40));
        push_log = new QPushButton(centralwidget);
        push_log->setObjectName(QString::fromUtf8("push_log"));
        push_log->setGeometry(QRect(120, 150, 60, 40));
        push_X = new QPushButton(centralwidget);
        push_X->setObjectName(QString::fromUtf8("push_X"));
        push_X->setGeometry(QRect(240, 150, 60, 40));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        push_log10->setText(QCoreApplication::translate("MainWindow", "log10", nullptr));
